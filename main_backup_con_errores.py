...
def import_modules():
    ...
    try:
        ...
        return {
            ...
            'sistema_inventario': sistema_inventario,
            # Módulo 5
...
def render_main_content(selected_module: str, selected_class: str):
    ...
    st.markdown("""    **Bienvenido al curso interactivo de Streamlit por Daniel Mardones**
    ...
    with col1:
        st.info("🎓 **Curso Streamlit Interactivo**: Navegación optimizada + DOM-safe")    with col2:
        st.metric("Streamlit", st.__version__)
    with col3:
        st.metric("Módulos", "10 clases totales")
    ...
    if selected_class:  # Si hay una clase seleccionada
        ...
        class_to_module = {
            ...
            "Clase 2: Sistema de inventario": modules['sistema_inventario'],
            # Módulo 5: Despliegue
